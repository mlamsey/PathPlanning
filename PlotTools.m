classdef PlotTools
	methods(Static)
        ...
        function ref = PlotContourWithTorchQuaternions(contour_data)
            if(~isa(contour_data,'Contour'))
                fprintf('PlotTools::PlotContourWithTorchQuaternions: Input not a contour\n');
                return;
            end%if
